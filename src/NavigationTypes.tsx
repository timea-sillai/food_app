...
export type BottomTabParamList = {
  ...
  export type CategoriesScreenProps = BottomTabScreenProps<BottomTabParamList, "Categories">;
  export type SearchScreenProps = BottomTabScreenProps<BottomTabParamList, "Search">;
  export type RecipesScreenProps = BottomTabScreenProps<BottomTabParamList, "Recipes">;